...
myst_html_meta = {
    "description": "IP2Location.io R Package allows user to query for an enriched data set based on IP address.",
    "keywords": "IP2Location, Geolocation, IP location, R, proxy, hosted domain",
...
html_title = "IP2Location.io R SDK"

html_baseurl = "https://ip2location-io-r.readthedocs.io/en/latest/"